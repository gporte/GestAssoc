...
using GestAssoc.Common.InteractionRequests.DefaultWindows;
...
namespace GestAssoc.Common.InteractionRequests
{
    ...
    public class PopupWindowAction : TriggerAction<FrameworkElement>
    {
        ...
        protected void PrepareContentForWindow(INotification notification, Window wrapperWindow)
        {
        ...
        /// <returns></returns>
        protected Window GetWindow(INotification notification)
        {
